      ...
      <footer style={{ padding: "32px 24px", paddingBottom: "calc(32px + 52px)", textAlign: "center", borderTop: "1px solid rgba(255,255,255,0.03)", background: "#080e1a" }}>
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: 8, flexWrap: "wrap", marginBottom: 12 }}>
            <div style={{ padding: "6px 12px", borderRadius: 6, background: "#1a1f71", display: "flex", alignItems: "center" }}>
              <span style={{ color: "#fff", fontSize: 13, fontWeight: 800, fontStyle: "italic", letterSpacing: 1 }}>VISA</span>
            </div>
            <div style={{ padding: "6px 12px", borderRadius: 6, background: "#1a1a1a", display: "flex", alignItems: "center", gap: 3 }}>
              <div style={{ width: 14, height: 14, borderRadius: "50%", background: "#EB001B", marginRight: -4 }} />
            ...
            <div style={{ padding: "6px 12px", borderRadius: 6, background: "#fff", border: "1px solid rgba(255,255,255,0.1)", display: "flex", alignItems: "center", gap: 3 }}>
              <span style={{ fontSize: 12, fontWeight: 700 }}><span style={{ color: "#4285F4" }}>G</span><span style={{ color: "#EA4335" }}>o</span><span style={{ color: "#FBBC05" }}>o</span><span style={{ color: "#4285F4" }}>g</span><span style={{ color: "#34A853" }}>l</span><span style={{ color: "#EA4335" }}>e</span></span>
              <span style={{ color: "#3C4043", fontSize: 11, fontWeight: 600, marginLeft: 2 }}>Pay</span>
            </div>
          </div>
          <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 6, marginBottom: 4 }}>
            ...
            <span style={{ color: "#635BFF", fontSize: 14, fontWeight: 700, letterSpacing: 0.5 }}>stripe</span>
          </div>
        </div>
