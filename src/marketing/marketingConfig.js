...
export const SEGMENTS = {
  ...
  en_camper: {
    ...
    lang: "en",
    label: "Camper EN",
    pain: "Planning a Croatia road trip in a motorhome but don't know where to park legally?",
    benefit: "JADRAN.AI finds legal camper spots, height restrictions and bura wind warnings along the Adriatic coast.",
    cta: "Try free →",
    headline: "Road trip Croatia — without the nasty surprises",
    subheadline: "AI guide for motorhomes: legal parking, height limits, dump stations, bura warnings",
    emailSubject: "Your Croatia camper van guide is ready 🚐",
    niche: "camper",
    lang_param: "en",
  },
  en_couple: {
