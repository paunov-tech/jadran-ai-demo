...
const DESTINATIONS = [
  ...
  { id:"rovinj",    name:"Rovinj",            region:"Istra",     tagline:{hr:"Najromantičniji grad",de:"Die romantischste Stadt",en:"Most romantic town",it:"La città più romantica"}, img:"https://images.unsplash.com/photo-1582979512210-99b6a53386f9?w=800&q=80", accent:"#fb923c" },
  ...
  { id:"pula",      name:"Pula",              region:"Istra",     tagline:{hr:"Rimska arena",de:"Römische Arena",en:"Roman Arena",it:"Arena Romana"}, img:"https://images.unsplash.com/photo-1590523277543-a94d2e4eb00b?w=800&q=80", accent:"#34d399" },
        ...
        <div style={{ maxWidth:640, margin:"0 auto" }}>
          ...
          <a href="https://vi.me/qku0x" target="_blank" rel="noopener noreferrer" style={{ display:"flex", alignItems:"center", justifyContent:"space-between", padding:"14px 18px", borderRadius:14, background:"rgba(34,197,94,0.06)", border:"1px solid rgba(34,197,94,0.15)", textDecoration:"none", marginTop:4 }}>
            <span style={{ fontFamily:"'Outfit',sans-serif", fontSize:13, color:"#22c55e", fontWeight:600 }}>
              {({hr:"Sve aktivnosti na Jadranu →", de:"Alle Aktivitäten auf der Adria →", en:"All Adriatic activities →", it:"Tutte le attività sull'Adriatico →"})[dl] || "Sve aktivnosti na Jadranu →"}
            </span>
