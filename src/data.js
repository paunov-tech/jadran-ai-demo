...
// ═══ CAMPSITE DATABASE — Top 40 along the coast ═══
// Curated for campervan travelers. Prices: high season per pitch+2 adults+electricity
export const CAMPSITES = [
  // ══ ISTRA ══
  { id: "cs_polari", name: "Maistra Camping Polari", city: "Rovinj", region: "istra", stars: 4, pitch: true, mobile: true, lat: 45.06, lon: 13.63, priceRange: "35-55€", pool: true, beach: "pebble", dogs: true, dump: true, wifi: true, electric: "16A", shade: "pine", note: "3.5km od centra Rovinja. Aqua park. Velik, šaren, animacija.", book: "maistra.com" },
  { id: "cs_vestar", name: "Maistra Camping Veštar", city: "Rovinj", region: "istra", stars: 4, pitch: true, mobile: true, lat: 45.04, lon: 13.63, priceRange: "35-55€", pool: true, beach: "pebble", dogs: true, dump: true, wifi: true, electric: "16A", shade: "pine", note: "Mirnija alternativa Polariju. Prekrasna uvala.", book: "maistra.com" },
  { id: "cs_stoja", name: "Camping Stoja", city: "Pula", region: "istra", stars: 3, pitch: true, mobile: false, lat: 44.85, lon: 13.83, priceRange: "25-40€", pool: false, beach: "rocky", dogs: true, dump: true, wifi: true, electric: "10A", shade: "pine", note: "2km od Arene! Najjeftiniji ozbiljni kamp blizu Pule.", book: "campingstoja.com" },
  { id: "cs_lanterna", name: "Valamar Camping Lanterna", city: "Tar-Vabriga", region: "istra", stars: 4, pitch: true, mobile: true, lat: 45.28, lon: 13.58, priceRange: "40-65€", pool: true, beach: "pebble", dogs: true, dump: true, wifi: true, electric: "16A", shade: "mixed", note: "Mega-resort, 3500 parcela! Aqua park, restoran. Nije za one koji traže mir.", book: "valamarcamping.com" },
  { id: "cs_monperin", name: "Camp Mon Perin", city: "Bale", region: "istra", stars: 3, pitch: true, mobile: true, lat: 45.03, lon: 13.78, priceRange: "25-38€", pool: false, beach: "rocky/1km", dogs: true, dump: true, wifi: true, electric: "16A", shade: "olive", note: "Tihi kamp u maslinicima. Odlican pritisak vode! Truffle tour u blizini.", book: "monperin.hr" },
  { id: "cs_umag", name: "Camping Park Umag", city: "Umag", region: "istra", stars: 4, pitch: true, mobile: true, lat: 45.43, lon: 13.52, priceRange: "35-55€", pool: true, beach: "pebble", dogs: true, dump: true, wifi: true, electric: "16A", shade: "pine", note: "Blizu granice SLO. Idealan prvi stop iz Austrije.", book: "istracamping.com" },
  // ══ KVARNER ══
  { id: "cs_omisalj", name: "Camping Omišalj", city: "Omišalj, Krk", region: "kvarner", stars: 3, pitch: true, mobile: true, lat: 45.21, lon: 14.55, priceRange: "28-42€", pool: false, beach: "pebble", dogs: true, dump: true, wifi: true, electric: "16A", shade: "pine", note: "Odmah nakon Krčkog mosta! Odlična baza za Krk.", book: "camping-omisalj.com" },
  { id: "cs_jezevac", name: "Valamar Camping Ježevac", city: "Krk grad", region: "kvarner", stars: 4, pitch: true, mobile: true, lat: 45.02, lon: 14.57, priceRange: "38-58€", pool: true, beach: "pebble", dogs: true, dump: true, wifi: true, electric: "16A", shade: "pine", note: "5 min hoda do starog grada Krka. Premium ali lokacija neprocjenjiva.", book: "valamarcamping.com" },
  { id: "cs_baska", name: "Baška Beach Camping Resort", city: "Baška, Krk", region: "kvarner", stars: 4, pitch: true, mobile: true, lat: 44.97, lon: 14.76, priceRange: "35-55€", pool: true, beach: "pebble", dogs: true, dump: true, wifi: true, electric: "16A", shade: "limited", note: "Blizu plaže Vela. Malo sjene — dolazite rano za bolje parcele.", book: "valamarcamping.com" },
  { id: "cs_padova", name: "Padova Premium Camping", city: "Banjol, Rab", region: "kvarner", stars: 4, pitch: true, mobile: true, lat: 44.75, lon: 14.77, priceRange: "35-52€", pool: true, beach: "pebble", dogs: true, dump: true, wifi: true, electric: "16A", shade: "pine", note: "Rab otok. Bus do centra. Lopar pijesak 10 min autom.", book: "valamarcamping.com" },
  { id: "cs_preluk", name: "Autokamp Preluk", city: "Rijeka/Opatija", region: "kvarner", stars: 2, pitch: true, mobile: false, lat: 45.35, lon: 14.34, priceRange: "18-28€", pool: false, beach: "concrete", dogs: true, dump: true, wifi: false, electric: "10A", shade: "minimal", note: "Najjeftiniji na Kvarneru! Bus 32 do Opatije. Basic ali funkcionalan.", book: "direktno" },
  { id: "cs_kovacine", name: "Camp Kovačine", city: "Cres", region: "kvarner", stars: 3, pitch: true, mobile: true, lat: 44.97, lon: 14.40, priceRange: "30-45€", pool: true, beach: "pebble", dogs: true, dump: true, wifi: true, electric: "16A", shade: "pine", note: "Cres grad 15 min hoda. PAŽNJA: ljeti ograničavaju vodu!", book: "camp-kovacine.com" },
  // ══ ZADAR / ŠIBENIK ══
  { id: "cs_strasko", name: "Camping Straško", city: "Novalja, Pag", region: "zadar", stars: 3, pitch: true, mobile: true, lat: 44.56, lon: 14.90, priceRange: "25-40€", pool: false, beach: "pebble", dogs: true, dump: true, wifi: true, electric: "16A", shade: "limited", note: "Blizu Zrće plaže ali kamp je miran. Pag sir i janjetina!", book: "strasko.com" },
  { id: "cs_borik", name: "Camping Borik", city: "Zadar", region: "zadar", stars: 3, pitch: true, mobile: false, lat: 44.14, lon: 15.20, priceRange: "25-38€", pool: false, beach: "pebble", dogs: true, dump: true, wifi: true, electric: "10A", shade: "pine", note: "3km od Morskih orgulja. Najbliži kamp centru Zadra.", book: "direktno" },
  { id: "cs_solaris", name: "Camping Solaris", city: "Šibenik", region: "zadar", stars: 4, pitch: true, mobile: true, lat: 43.71, lon: 15.87, priceRange: "35-55€", pool: true, beach: "sand", dogs: true, dump: true, wifi: true, electric: "16A", shade: "mixed", note: "Resort stil. Aquapark! NP Krka 15 min. Pijesak plaža — rijetko na Jadranu.", book: "solaris.hr" },
  { id: "cs_jezera", name: "Camping Jezera", city: "Jezera, Murter", region: "zadar", stars: 3, pitch: true, mobile: false, lat: 43.77, lon: 15.66, priceRange: "22-35€", pool: false, beach: "rocky", dogs: true, dump: true, wifi: true, electric: "10A", shade: "olive", note: "Polazište za NP Kornati. Mali i miran. Ribarski ambijent.", book: "direktno" },
  { id: "cs_soline", name: "Camping Soline", city: "Biograd na Moru", region: "zadar", stars: 4, pitch: true, mobile: true, lat: 43.93, lon: 15.45, priceRange: "30-50€", pool: true, beach: "pebble", dogs: true, dump: true, wifi: true, electric: "16A", shade: "pine", note: "Dobra baza za Kornate i NP Paklenica.", book: "campingsoline.com" },
  // ══ SPLIT / MAKARSKA ══
  { id: "cs_stobrec", name: "Camping Stobreč Split", city: "Stobreč", region: "split", stars: 4, pitch: true, mobile: true, lat: 43.50, lon: 16.49, priceRange: "35-55€", pool: true, beach: "pebble", dogs: true, dump: true, wifi: true, electric: "16A", shade: "mixed", note: "Najbliži kamp Splitu! Bus 25 do Dioklecijanove. 24/7 dump.", book: "campingsplit.com" },
  { id: "cs_seget", name: "Amadria Park Camping Trogir", city: "Seget Vranjica", region: "split", stars: 3, pitch: true, mobile: true, lat: 43.52, lon: 16.20, priceRange: "28-45€", pool: false, beach: "pebble", dogs: true, dump: true, wifi: true, electric: "16A", shade: "pine", note: "Pogled na stari grad Trogir. Trajekt za Čiovo 5 min.", book: "amadriapark.com" },
  { id: "cs_basko_polje", name: "Camping Baško Polje", city: "Baška Voda", region: "split", stars: 3, pitch: true, mobile: false, lat: 43.36, lon: 16.92, priceRange: "25-38€", pool: false, beach: "pebble", dogs: true, dump: true, wifi: true, electric: "10A", shade: "pine", note: "Rivijera Makarska. Direktan pristup s magistrale. Plaža 50m.", book: "direktno" },
  { id: "cs_galeb", name: "Camping Galeb", city: "Omiš", region: "split", stars: 3, pitch: true, mobile: false, lat: 43.44, lon: 16.70, priceRange: "22-35€", pool: false, beach: "pebble", dogs: true, dump: true, wifi: true, electric: "10A", shade: "pine", note: "Ušće Cetine. Rafting 5 min! Mali, obiteljski, miran.", book: "direktno" },
  { id: "cs_simuni", name: "Camping Village Šimuni", city: "Šimuni, Pag", region: "zadar", stars: 4, pitch: true, mobile: true, lat: 44.49, lon: 14.95, priceRange: "30-50€", pool: true, beach: "sandy", dogs: true, dump: true, wifi: true, electric: "16A", shade: "limited", note: "Rijedak pijesak na Pagu! Idealan za obitelji.", book: "camping-simuni.hr" },
  // ══ DUBROVNIK ══
  { id: "cs_solitudo", name: "Camping Solitudo", city: "Dubrovnik (Babin Kuk)", region: "dubrovnik", stars: 3, pitch: true, mobile: true, lat: 42.66, lon: 18.05, priceRange: "35-55€", pool: false, beach: "rocky", dogs: true, dump: true, wifi: true, electric: "16A", shade: "pine", note: "JEDINI kamp blizu Dubrovnika! Bus 6 do Starog grada. Rezervacija obavezna ljeti.", book: "campingsolitudo.com" },
  { id: "cs_nevio", name: "Camping Nevio", city: "Orebić, Pelješac", region: "dubrovnik", stars: 3, pitch: true, mobile: false, lat: 42.98, lon: 17.18, priceRange: "22-35€", pool: false, beach: "pebble", dogs: true, dump: true, wifi: true, electric: "10A", shade: "olive", note: "Pelješac. Trajekt Korčula 5 min. Vino i kamenice u blizini!", book: "direktno" },
  { id: "cs_port9", name: "Camping Port 9", city: "Korčula", region: "dubrovnik", stars: 4, pitch: true, mobile: true, lat: 42.94, lon: 17.13, priceRange: "32-48€", pool: true, beach: "pebble", dogs: true, dump: true, wifi: true, electric: "16A", shade: "pine", note: "Korčula grad 10 min hoda. Bazen + plaža.", book: "aminess.com" },
  // ══ GORSKI KOTAR / INLAND ══
  { id: "cs_korana", name: "Camping Korana", city: "Plitvička Jezera", region: "inland", stars: 3, pitch: true, mobile: true, lat: 44.90, lon: 15.60, priceRange: "25-40€", pool: false, beach: "river", dogs: true, dump: true, wifi: true, electric: "10A", shade: "forest", note: "Uz NP Plitvička Jezera! Rijeka Korana za kupanje. Tranzit Zagreb-Split.", book: "campingkorana.hr" },
  { id: "cs_zagreb", name: "Autocamp Zagreb", city: "Zagreb (Lučko)", region: "inland", stars: 2, pitch: true, mobile: false, lat: 45.76, lon: 15.89, priceRange: "18-28€", pool: false, beach: "none", dogs: true, dump: true, wifi: true, electric: "10A", shade: "minimal", note: "Uz A1 izlaz. Tranzitni kamp — prvi/zadnji stop. Non-stop dump.", book: "direktno" },
];
