...
export const VIATOR_FALLBACK = [
  ...
  { productCode:"LOCAL-002", title:"Plava špilja & 5 otoka",              description:"Posjetite Plavu špilju, Hvar, Brač i uvale Paklenih otoka.",                        price:79,  rating:4.9, reviewCount:3580, duration:"8h",   category:"Nautika",  images:["https://images.unsplash.com/photo-1503756234508-e32369269dde?w=400"], bookingUrl:"https://www.viator.com/tours/Split/?pid=P00292197&mcid=42383&medium=link" },
...
const T = {
  ...
  unlockPremium:{hr:"Otključaj Premium — 9.99€ →",de:"Premium freischalten — 9.99€ →",en:"Unlock Premium — 9.99€ →",it:"Sblocca Premium — 9.99€ →",si:"Odklenite Premium — 9.99€ →",cz:"Odemknout Premium — 9.99€ →",pl:"Odblokuj Premium — 9.99€ →"},
  entireStay:{hr:"za cijeli boravak · jednokratno",de:"für den gesamten Aufenthalt · einmalig",en:"for entire stay · one-time",it:"per tutto il soggiorno · una tantum",si:"za celotno bivanje · enkratno",cz:"na celý pobyt · jednorázově",pl:"na cały pobyt · jednorazowo"},
