...
export const EXPERIENCES = [
  ...
  // ═══ GAP FILL — Makarska ═══
  { id: 50, name: "Makarska 3-Island Speedboat", emoji: "🚤", price: 65, dur: "5h", rating: 4.8, cat: "adventure", region: "makarska",
    link: GYG("makarska-l2098/makarska-3-island-speedboat-tour-with-cave-and-blue-lagoon-t539821") },
  { id: 51, name: "Makarska Kayak Tour", emoji: "🛶", price: 45, dur: "3h", rating: 4.9, cat: "adventure", region: "makarska",
    link: VIA("Makarska/Kayaking-tour-in-beautiful-Makarska/d31483-315512P1") },
  { id: 52, name: "Cetina River Boat + Lunch", emoji: "🏞️", price: 85, dur: "8h", rating: 4.7, cat: "nature", region: "makarska",
    link: VIA("Makarska/Omis-and-river-Cetina-Day-Trip-from-Makarska-Riviera/d31483-5690P20") },
  { id: 53, name: "Hvar & Brač Boat Day Trip", emoji: "🏝️", price: 55, dur: "9h", rating: 4.6, cat: "premium", region: "makarska",
    link: GYG("makarska-l2098/from-makarska-full-day-boat-tour-to-hvar-and-brac-t7485") },
  // ═══ GAP FILL — Zadar ═══
  { id: 54, name: "Zadar Sunset Kayak", emoji: "🛶", price: 35, dur: "2.5h", rating: 4.9, cat: "adventure", region: "zadar",
    link: GYG("zadar-l936/zadar-sea-kayak-sunset-tour-t213890") },
  { id: 55, name: "Zrmanja River Rafting", emoji: "🏞️", price: 55, dur: "4h", rating: 4.8, cat: "adventure", region: "zadar",
    link: GYG("zadar-l936/obrovac-zrmanja-river-rafting-tour-t415233") },
  { id: 56, name: "Zadar Food & Wine Walk", emoji: "🍷", price: 65, dur: "3h", rating: 4.9, cat: "gastro", region: "zadar",
    link: GYG("zadar-l936/zadar-food-and-wine-walking-tour-t388127") },
  { id: 57, name: "Pag Island Cheese & Salt", emoji: "🧀", price: 70, dur: "8h", rating: 4.7, cat: "gastro", region: "zadar",
    link: GYG("zadar-l936/from-zadar-pag-island-cheese-salt-wine-day-trip-t421836") },
  // ═══ GAP FILL — Istra ═══
  { id: 58, name: "Rovinj Sunset Boat Tour", emoji: "🌅", price: 35, dur: "1.5h", rating: 4.8, cat: "premium", region: "istra",
    link: GYG("rovinj-l1299/rovinj-sunset-boat-tour-t467129") },
  { id: 59, name: "Pula Kayak & Snorkel Caves", emoji: "🛶", price: 45, dur: "3h", rating: 4.9, cat: "adventure", region: "istra",
    link: GYG("pula-l344/pula-sea-kayak-and-snorkel-caves-tour-t289311") },
  { id: 60, name: "Istria Olive Oil & Wine", emoji: "🫒", price: 60, dur: "5h", rating: 4.9, cat: "gastro", region: "istra",
    link: GYG("porec-l1300/istria-olive-oil-wine-and-truffle-tour-t425871") },
  { id: 61, name: "Brijuni National Park Boat", emoji: "🦌", price: 40, dur: "4h", rating: 4.6, cat: "nature", region: "istra",
    link: GYG("pula-l344/from-pula-brijuni-national-park-boat-trip-t375622") },
  // ═══ GAP FILL — Kvarner ═══
  { id: 62, name: "Rab Island Day Trip", emoji: "🏖️", price: 45, dur: "8h", rating: 4.7, cat: "adventure", region: "kvarner",
    link: GYG("krk-l4158/from-krk-rab-island-day-trip-by-boat-t509321") },
  { id: 63, name: "Krk Wine & Olive Oil Tour", emoji: "🍷", price: 55, dur: "4h", rating: 4.8, cat: "gastro", region: "kvarner",
    link: GYG("krk-l4158/krk-island-wine-olive-oil-tasting-tour-t487299") },
  { id: 64, name: "Cres Dolphin Watching", emoji: "🐬", price: 50, dur: "3h", rating: 4.9, cat: "nature", region: "kvarner",
    link: GYG("cres-l48721/mali-losinj-dolphin-watching-boat-tour-t521873") },
  // ═══ GAP FILL — Split extras ═══
  { id: 65, name: "Split Kayak Night Glow", emoji: "🛶", price: 40, dur: "2h", rating: 4.9, cat: "adventure", region: "split",
    link: GYG("split-l268/split-kayak-night-glow-tour-t438836") },
  { id: 66, name: "Split Food & Wine Walk", emoji: "🍷", price: 75, dur: "3h", rating: 4.9, cat: "gastro", region: "split",
    link: GYG("split-l268/split-food-and-wine-walking-tour-t289456") },
  { id: 67, name: "Omiš Zipline Adventure", emoji: "🎢", price: 40, dur: "2.5h", rating: 4.8, cat: "adventure", region: "split",
    link: GYG("omis-l2096/omis-zipline-adventure-over-cetina-canyon-t178965") },
  // ═══ GAP FILL — Dubrovnik extras ═══
  { id: 68, name: "Dubrovnik Kayak + Snorkel", emoji: "🛶", price: 35, dur: "3h", rating: 4.8, cat: "adventure", region: "dubrovnik",
    link: GYG("dubrovnik-l518/dubrovnik-sea-kayak-and-snorkel-tour-t184523") },
  { id: 69, name: "Ston Oysters + Pelješac Wine", emoji: "🦪", price: 85, dur: "8h", rating: 4.9, cat: "gastro", region: "dubrovnik",
    link: GYG("dubrovnik-l518/from-dubrovnik-peljesac-peninsula-wine-oyster-tour-t358912") },
  { id: 70, name: "Lokrum Island Half Day", emoji: "🏝️", price: 22, dur: "4h", rating: 4.7, cat: "nature", region: "dubrovnik",
    link: GYG("dubrovnik-l518/dubrovnik-lokrum-island-tour-t291478") },
];
