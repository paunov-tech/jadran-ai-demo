...
const T = {
  hr: { title: "Jadran Vodič", sub: "Lokalni savjeti za savršen odmor", start: "Započnite razgovor", send: "Pošalji", placeholder: "Pitajte me o Jadranu...", region: "Odaberite regiju", mode: "Kako putujete?", unlock: "Otključaj — od 4.99€", free3: "3 besplatna pitanja", remaining: "preostalo", upgraded: "Premium otključan!", back: "Natrag", typing: "razmišljam...",
    // Niche setup
      ...
      <div onClick={e => e.stopPropagation()} style={{ background: isNight ? "rgba(12,28,50,0.97)" : "rgba(255,255,255,0.97)", borderRadius: 24, padding: "32px 24px", maxWidth: 440, width: "100%", border: "1px solid rgba(245,158,11,0.1)", maxHeight: "90dvh", overflowY: "auto", WebkitOverflowScrolling: "touch" }}>
        ...
        <div style={{ display: "flex", gap: 10, marginBottom: 16 }}>
          <button onClick={() => startCheckout("week")} disabled={payLoading}
            ...
            <div style={{ fontSize: 28, fontWeight: 300, color: C.accent }}>4.99€</div>
          ...
          <button onClick={() => startCheckout("season")} disabled={payLoading}
            ...
            <div style={{ fontSize: 28, fontWeight: 300, color: C.gold }}>9.99€</div>
    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.7)", backdropFilter: "blur(12px)", zIndex: 400, display: "grid", placeItems: "center", padding: 24 }}
      ...
      <div onClick={e => e.stopPropagation()} style={{ background: isNight ? "rgba(12,28,50,0.97)" : "rgba(255,255,255,0.97)", borderRadius: 24, padding: "32px 24px", maxWidth: 440, width: "100%", border: "1px solid rgba(34,197,94,0.15)", textAlign: "center" }}>
        ...
        <div style={{ padding: "12px 16px", borderRadius: 12, background: isNight ? "rgba(255,255,255,0.02)" : "rgba(0,0,0,0.02)", border: `1px solid ${C.bord}`, marginBottom: 16, fontSize: 11, color: C.mut, textAlign: "left" }}>
          ...
          <div>Stripe · {premiumPlan?.plan === "season" ? "9.99€" : "4.99€"}</div>
