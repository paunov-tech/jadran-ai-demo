...
const FALLBACK = [
  ...
  { ic: "🍷", hr: "Pelješac vinari otvorili sezonske degustacije Plavca Malija — rezerviraj turu direktno u podrumu uz more.", en: "Pelješac Plavac Mali wineries open for season tastings — book a cellar tour by the sea.", de: "Pelješac-Weingüter öffnen für Saison-Verkostungen von Plavac Mali — Kellerführung am Meer buchbar.", it: "Cantine Pelješac aprono per degustazioni stagionali del Plavac Mali — prenota un tour in cantina." },
  ...
  { ic: "🎭", get hr() { const d=Math.ceil((new Date(new Date().getFullYear()+"-07-10")-Date.now())/86400000); return d>0?`Splitsko ljeto počinje za ${d} dana. Ove godine: opera na Peristilu i jazz u podrumima Palače.`:"Splitsko ljeto je počelo! Opera na Peristilu, jazz u podrumima Dioklecijanove palače."; }, get en() { const d=Math.ceil((new Date(new Date().getFullYear()+"-07-10")-Date.now())/86400000); return d>0?`Split Summer starts in ${d} days. Opera at the Peristyle, jazz in Palace basements.`:"Split Summer has started! Opera at the Peristyle, jazz in the Palace basements."; }, get de() { const d=Math.ceil((new Date(new Date().getFullYear()+"-07-10")-Date.now())/86400000); return d>0?`Spalato Sommer beginnt in ${d} Tagen. Oper am Peristyl, Jazz im Palastkeller.`:"Spalato Sommer hat begonnen! Oper am Peristyl, Jazz im Palastkeller."; }, get it() { const d=Math.ceil((new Date(new Date().getFullYear()+"-07-10")-Date.now())/86400000); return d>0?`Estate di Spalato inizia tra ${d} giorni. Opera al Peristilio, jazz nei sotterranei.`:"Estate di Spalato iniziata! Opera al Peristilio, jazz nei sotterranei."; } },
